...
namespace CSharpFunctionalExtensions.Analyzers.UseResultValueWithoutCheck_olbd;

[DiagnosticAnalyzer(LanguageNames.CSharp)]
public class UseResultValueWithoutCheck_older : DiagnosticAnalyzer
{
    public const string DiagnosticId = "CFE099";
